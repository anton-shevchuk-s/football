@foreach ($calendar as $matchDayGames)
<p>
    {{ $matchDayGames['matchDayNumber'] }}<sup>{{ $matchDayGames['matchDaySuffix'] }}</sup> week Match Results
</p>
<table class="table table-sm">
    @foreach ($matchDayGames['games'] as $game)
    <tr>
